...
public final class BlockMEOreDictionaryInputBus extends BlockMEItemBus {
    public BlockMEOreDictionaryInputBus() {
        setRegistryName(Tags.MOD_ID, "meoredictionaryinputbus");
        setTranslationKey(Tags.MOD_ID + ".meoredictionaryinputbus");
        setCreativeTab(MMCEMoreBusCreativeTab.INSTANCE);
    }

    @Override
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new MEOreDictionaryInputBus();
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
        ...
        if (!world.isRemote) {
            player.openGui(MMCEMoreBus.instance, MMCEGuiHandler.ME_ORE_DICTIONARY_INPUT_BUS,
