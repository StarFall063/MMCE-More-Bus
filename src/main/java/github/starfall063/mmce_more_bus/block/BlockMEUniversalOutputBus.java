...
public final class BlockMEUniversalOutputBus extends BlockMEItemBus {
    public BlockMEUniversalOutputBus() {
        setRegistryName(Tags.MOD_ID, "meuniversaloutputbus");
        setTranslationKey(Tags.MOD_ID + ".meuniversaloutputbus");
        setCreativeTab(MMCEMoreBusCreativeTab.INSTANCE);
    }

    @Override
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new MEUniversalOutputBus();
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
        ...
        if (!world.isRemote) {
            player.openGui(MMCEMoreBus.instance, MMCEGuiHandler.ME_UNIVERSAL_OUTPUT_BUS,
